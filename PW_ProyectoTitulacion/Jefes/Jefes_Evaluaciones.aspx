<%@ Page Title="" Language="C#" MasterPageFile="~/Jefes_PageMaster.Master" AutoEventWireup="true" CodeBehind="Jefes_Evaluaciones.aspx.cs" Inherits="PW_ProyectoTitulacion.Jefes.Jefes_Evaluaciones" %>
                ...
                <ContentTemplate>
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <asp:DropDownList ID="dllPeriodos" AutoPostBack="true" runat="server" OnSelectedIndexChanged="dllPeriodos_SelectedIndexChanged"></asp:DropDownList>
                        </div>
...
AS Nombres, OCKO_TblEmpleado.EmpCedula, OCKO_TblEmpleado.EmpJefe, OCKO_TblEmpleado.EmpJefeId
