...
where (OCKO_TblCategoriaPregunta.CatId = @Categoria and OCKO_TblTipoEvaluacion.TipId = @evaluacion and OCKO_TblPreguntas.PreId =@pregunta)">
                         ...
                         <asp:sqldatasource ID="sdsPreguntas" runat="server" ConnectionString="<%$ ConnectionStrings:OCKO_EvaluacionPersonal %>" SelectCommand="select OCKO_TblPreguntas.PreId ,OCKO_TblPreguntas.PrePregunta,OCKO_TblPreguntas.PreDescripcion
